...
class __TwigTemplate_6986d18f07c349252dd581069dc603b59ffaeed606c7c60eca6283ffd1cbdd6d extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <div class=\"modal-dialog\" role=\"document\">
            <div class=\"modal-content\">
                <div class=\"modal-header\">
                    <h5 class=\"modal-title\">Poster un Feedback</h5>
    ...
    <script>
        function editReview(){
            const textarea= document.getElementById('user_review');
            let badwords = /bite|baisable|baise|baiser|bander|branle|branlette|bordel|burnes|chatte|chiant|chiasse|chier|chiottes|con|conne|connerie|coucougnettes|couilles|couillu|cul|déconner|déconneur|emmerder|emmerdant|emmerdeur|entuber|foutre|merde merdier|merdique|niquer|nique|pisser|putain|pute|démerder|emmerder|chier| sucer|ta gueule|zob/gi;
            let user_review1 = textarea.value;
            let user_review2 = user_review1.replace(badwords,\"****\");
            document.getElementById('user_review').value=user_review2;
        }
        document.getElementById('save_review').addEventListener('click',editReview);
    </script>
";
...
{% endblock %}", "front/Review/show.html.twig", "C:\\Users\\lahma\\Downloads\\Foodine_PIDEV-Gestion_Utilisateur_Ines\\templates\\front\\Review\\show.html.twig");
    }
}
