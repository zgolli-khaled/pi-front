...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ELHOrGqevP', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NK2O5m5iNO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gF+pAC8oHh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JyjCto8PZS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j57Dpz1dqo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mnmTCjAat-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('25BqWP2B5l', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder3ab4d = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerfeb97 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesce3a1 = [
        
    ];

    public function getConnection()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getConnection', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getMetadataFactory', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getExpressionBuilder', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'beginTransaction', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getCache', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getCache();
    }

    public function transactional($func)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'transactional', array('func' => $func), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'wrapInTransaction', array('func' => $func), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'commit', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->commit();
    }

    public function rollback()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'rollback', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getClassMetadata', array('className' => $className), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'createQuery', array('dql' => $dql), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'createNamedQuery', array('name' => $name), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'createQueryBuilder', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'flush', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'clear', array('entityName' => $entityName), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->clear($entityName);
    }

    public function close()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'close', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->close();
    }

    public function persist($entity)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'persist', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'remove', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->remove($entity);
    }

    public function refresh($entity, ?int $lockMode = null)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'refresh', array('entity' => $entity, 'lockMode' => $lockMode), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->refresh($entity, $lockMode);
    }

    public function detach($entity)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'detach', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'merge', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getRepository', array('entityName' => $entityName), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'contains', array('entity' => $entity), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getEventManager', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getConfiguration', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'isOpen', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getUnitOfWork', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getProxyFactory', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'initializeObject', array('obj' => $obj), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'getFilters', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'isFiltersStateClean', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'hasFilters', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return $this->valueHolder3ab4d->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerfeb97 = $initializer;
    ...
    public function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, ?\Doctrine\Common\EventManager $eventManager = null)
    {
        ...
        if (! $this->valueHolder3ab4d) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder3ab4d = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder3ab4d->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__get', ['name' => $name], $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        if (isset(self::$publicPropertiesce3a1[$name])) {
            return $this->valueHolder3ab4d->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder3ab4d;
    ...
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;
    ...
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__isset', array('name' => $name), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;
    ...
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__unset', array('name' => $name), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;
    ...
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__clone', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        $this->valueHolder3ab4d = clone $this->valueHolder3ab4d;
    }

    public function __sleep()
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, '__sleep', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        return array('valueHolder3ab4d');
    }
    ...
    {
        $this->initializerfeb97 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerfeb97;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'initializeProxy', array(), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder3ab4d;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder3ab4d;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerfeb97 && ($this->initializerfeb97->__invoke($valueHolder3ab4d, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerfeb97) || 1) && $this->valueHolder3ab4d = $valueHolder3ab4d;

        if ($this->valueHolder3ab4d === $returnValue = $this->valueHolder3ab4d->paginate($target, $page, $limit, $options)) {
            return $this;
        }
